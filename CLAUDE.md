...
| [.claude/specs/sistema-agentico-unificado.md](.claude/specs/sistema-agentico-unificado.md) | **Propuesta, sin implementar.** Plan 1.4.0 → 2.0.0: chat integral único para todos los módulos, sistema `@` de contexto, IA en bases de datos y SSH/SFTP, módulo nuevo Vault Notes (grafo + bloques, cifrado), servidor MCP nativo embebido y AI Access Firewall |
