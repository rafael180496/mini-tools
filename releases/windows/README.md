...
|---|---|
| Versión | 0.2.2 |
| Archivo | `mini-tools-v0.2.2-windows-amd64.exe` |
| Tamaño | ~46 MB |
...
```powershell
Get-FileHash mini-tools-v0.2.2-windows-amd64.exe -Algorithm SHA256
...
1. Descargar `mini-tools-v0.2.2-windows-amd64.exe`.
