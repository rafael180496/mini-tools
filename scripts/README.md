...
| `changelog-section.sh` | `X.Y.Z` — imprime las notas de esa versión del `CHANGELOG.md`, sin su encabezado. | Lo usa el workflow de release para armar el cuerpo del GitHub Release; a mano sirve para revisar qué va a salir antes de empujar el tag. |
