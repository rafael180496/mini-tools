...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.5.2.dmg](releases/macos/mini-tools-v0.5.2.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.5.2-windows-amd64.exe](releases/windows/mini-tools-v0.5.2-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). Verificado en Windows 10 y 11. |
...
| Archivo | **[⬇ Descargar mini-tools-v0.5.2.dmg](releases/macos/mini-tools-v0.5.2.dmg)** |
| SHA-256 | `a06992765cc2215a015c62d37caf4ae98022eb82b90a8af92d1be7ad646338b9` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.5.2-windows-amd64.exe](releases/windows/mini-tools-v0.5.2-windows-amd64.exe)** |
