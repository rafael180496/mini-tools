...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.2.4.dmg](releases/macos/mini-tools-v0.2.4.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.2.4-windows-amd64.exe](releases/windows/mini-tools-v0.2.4-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). ⚠️ No verificado corriendo en Windows real todavía. |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.4.dmg](releases/macos/mini-tools-v0.2.4.dmg)** |
| SHA-256 | `4f1e349cde44ff7ff3b65aa6fa5a8a9ca4167d2c74aa3e9b28971f11f7255996` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.4-windows-amd64.exe](releases/windows/mini-tools-v0.2.4-windows-amd64.exe)** |
| SHA-256 | `7f4bddffbbacefdbfa4fe19fe90d830959511519fac616de78aa83647d099437` |
