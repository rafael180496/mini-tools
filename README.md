...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.2.5.dmg](releases/macos/mini-tools-v0.2.5.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.2.5-windows-amd64.exe](releases/windows/mini-tools-v0.2.5-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). ⚠️ No verificado corriendo en Windows real todavía. |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.5.dmg](releases/macos/mini-tools-v0.2.5.dmg)** |
| SHA-256 | `6534b2574fc5cc3a93db557802979e6fdb967cbec3c53b63538978cb345f18e6` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.5-windows-amd64.exe](releases/windows/mini-tools-v0.2.5-windows-amd64.exe)** |
