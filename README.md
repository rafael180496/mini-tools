...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.3.0.dmg](releases/macos/mini-tools-v0.3.0.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.3.0-windows-amd64.exe](releases/windows/mini-tools-v0.3.0-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). ⚠️ No verificado corriendo en Windows real todavía. |
...
| Archivo | **[⬇ Descargar mini-tools-v0.3.0.dmg](releases/macos/mini-tools-v0.3.0.dmg)** |
| SHA-256 | `bc6245a71e72b1bdbfa10b260e9bc8e22b13031aa7d562402fbef06590786757` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.3.0-windows-amd64.exe](releases/windows/mini-tools-v0.3.0-windows-amd64.exe)** |
