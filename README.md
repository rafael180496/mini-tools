...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.5.1.dmg](releases/macos/mini-tools-v0.5.1.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.5.1-windows-amd64.exe](releases/windows/mini-tools-v0.5.1-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). Verificado en Windows 10 y 11. |
...
### 🌿 Cliente Git integrado <sub>· nuevo en 0.5.1</sub>
...
| Archivo | **[⬇ Descargar mini-tools-v0.5.1.dmg](releases/macos/mini-tools-v0.5.1.dmg)** |
| SHA-256 | `1c3b54fc3f8a1ed1e45711813e8e54a1a7e80a5edaab567640f7ff527f2a33d4` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.5.1-windows-amd64.exe](releases/windows/mini-tools-v0.5.1-windows-amd64.exe)** |
