...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.2.3.dmg](releases/macos/mini-tools-v0.2.3.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.2.3-windows-amd64.exe](releases/windows/mini-tools-v0.2.3-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). ⚠️ No verificado corriendo en Windows real todavía. |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.3.dmg](releases/macos/mini-tools-v0.2.3.dmg)** |
| SHA-256 | `8f3449702388e51edba39fdb8f47bea4256edcf81fcc50484865b257f06002e4` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.3-windows-amd64.exe](releases/windows/mini-tools-v0.2.3-windows-amd64.exe)** |
| SHA-256 | `7bde38bb999309478fdc4fd9285683fd9009ba250875ce46e4d4725d10a07338` |
