...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.5.0.dmg](releases/macos/mini-tools-v0.5.0.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.5.0-windows-amd64.exe](releases/windows/mini-tools-v0.5.0-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). Verificado en Windows 10 y 11. |
...
| Archivo | **[⬇ Descargar mini-tools-v0.5.0.dmg](releases/macos/mini-tools-v0.5.0.dmg)** |
| SHA-256 | `9343d2e5a1d43201ead175f110da61bf88806b3ef4a4decb5beca65fa5652077` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.5.0-windows-amd64.exe](releases/windows/mini-tools-v0.5.0-windows-amd64.exe)** |
