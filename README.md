...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.2.2.dmg](releases/macos/mini-tools-v0.2.2.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.2.2-windows-amd64.exe](releases/windows/mini-tools-v0.2.2-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). ⚠️ No verificado corriendo en Windows real todavía. |
...
- **4 motores nativos**: Oracle (TNS / Easy Connect / SID / Service Name), PostgreSQL (SSL modes completos), SQLite — vía `database/sql`, sin cliente Oracle/Postgres instalado aparte — y Redis (Standalone/Cluster/Sentinel, ACL, TLS) vía `go-redis`, con soporte de primera clase para RediSearch (`FT.SEARCH`/`FT.AGGREGATE`) y RedisJSON (`JSON.*`).
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.2.dmg](releases/macos/mini-tools-v0.2.2.dmg)** |
| SHA-256 | `3c93e7464c623e775de587f915c54f71d98874bdd0de8ab6e86eb36d4f853b6f` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.2-windows-amd64.exe](releases/windows/mini-tools-v0.2.2-windows-amd64.exe)** |
| SHA-256 | `9cd5d75cd78401251ecbb5867ea1f9b55b55b8fc736dbda55b69579b950f649b` |
