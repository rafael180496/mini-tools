...
|---|---|---|
| macOS (Apple Silicon) | **[⬇ mini-tools-v0.2.1.dmg](releases/macos/mini-tools-v0.2.1.dmg)** | Sin firmar — Gatekeeper avisa "desarrollador no identificado", ver [workaround](#distribución--empaquetado-macos) |
| Windows (x86-64) | **[⬇ mini-tools-v0.2.1-windows-amd64.exe](releases/windows/mini-tools-v0.2.1-windows-amd64.exe)** | Portable, sin instalador, sin firmar — SmartScreen avisa, ver [workaround](#distribución--empaquetado-windows). ⚠️ No verificado corriendo en Windows real todavía. |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.1.dmg](releases/macos/mini-tools-v0.2.1.dmg)** |
| SHA-256 | `f6b674b3c9fe2bc1f8ac078755f1658bba2d2515f2a0d6c299f087a1f953e82d` |
...
| Archivo | **[⬇ Descargar mini-tools-v0.2.1-windows-amd64.exe](releases/windows/mini-tools-v0.2.1-windows-amd64.exe)** |
