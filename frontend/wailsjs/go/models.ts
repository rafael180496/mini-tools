...
export namespace httpclient {
	...
	export class ImportDetection {
	    ...
	    static createFrom(source: any = {}) {
	        return new ImportDetection(source);
	    }
...
export namespace main {
	...
	export class HttpImportOutcome {
	    kind: string;
	    source?: string;
	    collectionId?: string;
	    itemId?: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new HttpImportOutcome(source);
	    }
	...
	export class HttpImportBatch {
	    items: HttpImportOutcome[];
	    collections: number;
	    environments: number;
	    requests: number;
	    folders: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new HttpImportBatch(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.items = this.convertValues(source["items"], HttpImportOutcome);
	        this.collections = source["collections"];
...
export namespace vault {
	...
	export class HTTPCollection {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.favoriteAt = source["favoriteAt"];
	        this.createdAt = source["createdAt"];
	        this.updatedAt = source["updatedAt"];
	    }
	}
