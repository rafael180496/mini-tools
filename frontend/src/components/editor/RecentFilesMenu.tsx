...
export default function RecentFilesMenu({onOpen}: RecentFilesMenuProps) {
    ...
    return (
        <div className="relative">
            ...
            {open && (
                <div className="absolute right-0 z-10 mt-1 w-72 rounded border border-neutral-800 bg-neutral-900 p-1 shadow-lg">
                    ...
                    {files.length > 0 && (
                        <button
                            ...
                            className="mt-1 block w-full rounded px-2 py-1 text-left text-xs text-neutral-600 hover:bg-neutral-800 hover:text-neutral-400"
                        >
                            Limpiar historial
                        </button>
                    )}
